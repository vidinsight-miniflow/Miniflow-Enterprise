...
from qbitra.app.schemas.auth import (
    RegisterRequest,
    RegisterResponse,
    LoginRequest,
    LoginResponse,
...
from qbitra.app.dependencies.auth.jwt_auth import authenticate_user, AuthenticatedUser
from qbitra.services import LoginService, RegistrationService
from qbitra.app.dependencies.service_providers import get_login_service, get_registration_service
...
async def get_current_user(
    ...
    try:
        ...
        from qbitra.database import with_readonly_session
